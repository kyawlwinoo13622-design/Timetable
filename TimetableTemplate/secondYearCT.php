...
<body>
    ...
    include("databaseConnection.php");
            $query="SELECT * FROM alldata";
                  ...
                  //  $monday=[];
                   ...
                   $time[5]="3:00_4:00";
                    ...
                    for($j=0;$j<5;$j++){
                      ...
                      for($r=0;$r<6;$r++){
                      if($c==$r1 && $M==$r5 &&  $day[$j]==$r3 && $time[$r]==$r4){
                  ...
                  $M="CT";
                  $m=mysqli_query($db,"select distinct Subject,SubjectCode,TeacherName from alldata where Class='$c' and Major='$M'");
                  if($m){
                    while($row=mysqli_fetch_assoc($m))
                    {
                      ...
                      <div class="row">
                      <div class="col mole"><?php echo $row['Subject']?></div>
                      <div class="col mole"><?php echo $row['SubjectCode']?></div>
                      <div class="col mole"><?php echo $row['TeacherName']?></div>
                      </div>
                        <?php
                    }
                  }
